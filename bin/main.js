...
(function(){
  var C, Compilers, Toc, fs, Path, mkdirp, glob, stringHash, base58, bs, chokidar, frontMatter, onChange, pug, state, emptyLayout, site, tocc, watcher, allIn, allDone, writeOne, processFile, rebuild, theError, slice$ = [].slice, join$ = [].join;
