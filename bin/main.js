...
(function(){
  var C, Compilers, Toc, fs, Path, mkdirp, glob, stringHash, base58, isbinaryfile, bs, chokidar, frontMatter, onChange, pug, args, ref$, state, emptyLayout, site, watcher, allIn, allDone, writeOne, processFile, rebuild, theError, slice$ = [].slice, join$ = [].join;
