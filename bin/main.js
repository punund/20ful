...
(function(){
  var C, Compilers, Toc, fs, Path, mkdirp, glob, stringHash, base58, log, bs, chokidar, frontMatter, onChange, pug, state, emptyLayout, site, tocc, watcher, allDone, writeOne, processFile, rebuild, theError, slice$ = [].slice, join$ = [].join;
