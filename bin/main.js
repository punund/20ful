...
(function(){
  var C, Compilers, Toc, fs, Path, mkdirp, glob, stringHash, base58, isbinaryfile, bs, chokidar, frontMatter, pug, args, ref$, state, emptyLayout, site, watcher, allIn, writeOne, processFile, rebuild, theError, slice$ = [].slice, join$ = [].join;
